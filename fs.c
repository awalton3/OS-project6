...
int fs_read( int inumber, char *data, int length, int offset )
{
	...
	while (bytes_read < length) {
		...
		// indirect block section
			...
			//printf("current_indirect_index: %d\n", current_indirect_index);
